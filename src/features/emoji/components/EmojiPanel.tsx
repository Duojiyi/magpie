...
// fetch("/emoji-data.json") 失败时的兜底分组。必须与 public/emoji-data.json 内容保持一致：
// - 不含 ZWJ（U+200D）组合 emoji（避免在某些 Windows emoji 字体下被拆字渲染）
// - 不含中文字面量（如旧版"物品"组的"键盘"应为 ⌨️）
// 任何对 emoji-data.json 的修改都需同步到此 fallback。
